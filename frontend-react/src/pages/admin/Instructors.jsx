            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-800">
                {filteredInstructors.map((instructor) => (
                  <tr key={instructor.id} className="hover:bg-gray-800/50 transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-400">ID: {instructor.id}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      ...
                      {instructor.phone && (
                        <div className="text-xs text-gray-400 mt-1">{instructor.phone}</div>
                      )}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          <div className="p-6">
            ...
            <div className="flex gap-3 justify-end">
              <button
                ...
                className="px-4 py-2 border border-gray-300 dark:border-gray-600 text-white rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              >
                Cancel
              </button>
              <button
            ...
            <>
              ...
              <div className="flex items-start gap-4 pb-6 mb-6 border-b border-gray-700">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-xl font-bold text-white mb-3">{instructorDetails.name}</h3>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="bg-gray-800 rounded-lg p-3 text-center border border-gray-700">
                      <div className="text-2xl font-bold text-blue-400">{instructorDetails.statistics?.courses || 0}</div>
                ...
                {instructorDetails.courses && Array.isArray(instructorDetails.courses) && instructorDetails.courses.length > 0 ? (
                  <div className="bg-gray-800 rounded-lg border border-gray-700 divide-y divide-gray-700">
                    {instructorDetails.courses.map((course, index) => (
                      <div key={course.id} className="p-4 hover:bg-gray-700/30 transition-colors">
                        <div className="flex items-start justify-between gap-3 mb-2">
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-sm text-gray-400 mb-2">Course Code: {course.code}</div>
                            {course.description && (
                  ...
                  <div className="text-center py-12 bg-gray-800/50 rounded-lg border border-gray-700">
                    ...
                    <p className="text-gray-400">No courses assigned to this instructor</p>
                  </div>
                )}
              </div>
            </>
