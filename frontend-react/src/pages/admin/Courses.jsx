...
export default function AdminCourses() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Search */}
      <div className="bg-gray-900 rounded-lg shadow-sm p-6 border border-orange-500">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-orange-500 rounded-lg focus:ring-2 focus:ring-orange-600 focus:border-transparent bg-white text-gray-900 placeholder-gray-500"
          />
        </div>
      </div>
      ...
      <div className="hidden md:block">
        ...
        {loading ? (
          ...
          <div className="bg-gray-900 rounded-lg shadow-sm overflow-hidden border border-orange-500">
      ...
      <div className="block md:hidden">
        ...
        {loading ? (
          ...
          <div className="bg-gray-900 rounded-lg shadow-sm p-12 text-center border border-orange-500">
            <BookOpen className="w-16 h-16 text-gray-400 mx-auto mb-4" />
            <p className="text-gray-600 dark:text-gray-400">
              {searchTerm ? 'No courses found' : 'No courses available'}
            </p>
