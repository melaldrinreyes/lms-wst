          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="flex items-start justify-between gap-4">
              <div className="flex items-start gap-4 flex-1">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">Course Content Creator</h2>
                  <p className="text-gray-600 text-sm mb-3">Create rich formatted course material for your students with videos, images, tables, and more</p>
                  <div className="flex flex-wrap gap-3">
                    <span className="px-3 py-1 bg-blue-100 border border-blue-200 rounded-full text-xs text-blue-700">📝 Rich Text Formatting</span>
                    <span className="px-3 py-1 bg-blue-100 border border-blue-200 rounded-full text-xs text-blue-700">🎥 Video Embedding</span>
                    <span className="px-3 py-1 bg-blue-100 border border-blue-200 rounded-full text-xs text-blue-700">🖼️ Images & Tables</span>
                  </div>
                </div>
              </div>
              <div className="px-4 py-2 bg-green-100 border border-green-200 rounded-lg text-xs font-semibold text-green-700">
                ✓ WYSIWYG Editor
              </div>
            </div>
          </div>
