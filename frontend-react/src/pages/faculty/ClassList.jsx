    ...
    <div className="space-y-6">
      ...
      {classes.length === 0 ? (
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800 p-12 text-center">
          ...
          <button
            onClick={() => navigate('/faculty/classes/new')}
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-semibold hover:from-orange-600 hover:to-orange-700 transition-all shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {classes.map((classItem) => (
            <div
              key={classItem.id}
              className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 overflow-hidden border border-gray-200 dark:border-gray-800 hover:border-orange-500/50"
            >
              ...
              {/* Actions */}
              <div className="border-t border-gray-200 dark:border-gray-800 p-3 bg-gray-50 dark:bg-gray-800/50 flex gap-2">
                <button
                  onClick={() => navigate(`/faculty/classes/${classItem.id}`)}
                  className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-blue-500/10 text-blue-500 rounded-xl hover:bg-blue-500/20 transition-all font-medium border border-blue-500/20"
                  title="View Students"
                >
                ...
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 bg-orange-500/10 text-orange-500 rounded-xl hover:bg-orange-500/20 transition-all font-medium border border-orange-500/20"
                  title="Edit Class"
                >
          ...
          <div className="modal-panel modal-panel--md bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full p-6 border border-gray-200 dark:border-gray-800">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-2.5 bg-gray-800/50 dark:bg-gray-800 hover:bg-gray-700 dark:hover:bg-gray-700 text-white rounded-xl font-medium transition-all border border-gray-700 dark:border-gray-600"
              >
                Cancel
              </button>
              <button
                onClick={() => handleDelete(deleteConfirm)}
                className="flex-1 px-4 py-2.5 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-xl font-medium transition-all shadow-lg shadow-red-500/30 hover:shadow-red-500/50"
              >
                Delete
              </button>
            </div>
