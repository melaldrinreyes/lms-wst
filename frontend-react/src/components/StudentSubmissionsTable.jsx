...
/**
 * Reusable StudentSubmissionsTable component
 * Props:
 * - submissions: array of submission objects
 * - courses: array of course objects (optional)
 * - onDownload: function(submissionId, studentName)
 * - onGrade: function(submission, gradeData)
 * - loading: boolean
...
export default function StudentSubmissionsTable({
  ...
  const handleGradeSubmission = () => {
    ...
    if (onGrade && selectedSubmission) {
      onGrade(selectedSubmission, gradeData);
              ...
              {selectedSubmission.file_path && (
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() => onDownload && onDownload(selectedSubmission.id, selectedSubmission.student_name)}
