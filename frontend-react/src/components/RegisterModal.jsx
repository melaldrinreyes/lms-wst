            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="text-center mb-5">
                  <div className="inline-block w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center mb-3 shadow-lg shadow-orange-500/50">
                ...
                <button
                  onClick={onClose}
                  className="block w-full text-center py-2 bg-gray-800/50 hover:bg-gray-800 text-white text-sm rounded-xl font-semibold transition border border-gray-700 hover:border-gray-600"
                >
                  Sign In Instead
                </button>
              </div>
